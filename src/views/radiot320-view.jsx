...
import lat from "../assets/t320_lat.jpg";
import front from "../assets/t320_front.jpg";
import sup from "../assets/t320_pos.jpg";
                                        ...
                                        <Table sx={{ minWidth: 650 }} aria-label="simple table">
                                            <TableBody>
                                                ...
                                                <TableRow sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                                                    ...
                                                    <TableCell align="center">ADAPTABLE</TableCell>
                                                ...
                                                <TableRow sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                                                    ...
                                                    <TableCell align="center">MT6739</TableCell>
                                                ...
                                                <TableRow sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                                                    ...
                                                    <TableCell align="center">1GB RAM + 8GB ROM</TableCell>
                                                ...
                                                <TableRow sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                                                    ...
                                                    <TableCell align="center">3500mAh</TableCell>
                                                    <TableCell align="left"><strong>WEIGHT</strong></TableCell>
                                                    <TableCell align="center">≈257g</TableCell>
                                                </TableRow>
                                                <TableRow sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                                                    <TableCell align="left"><strong>MICRÓFONO</strong></TableCell>
                                                    <TableCell align="center">Micrófono principal + micrófono auxiliar, reducción de ruido de micrófono dual</TableCell>
                                                    <TableCell align="left"><strong>IP RATE</strong></TableCell>
                                                    <TableCell align="center">IP65</TableCell>
                                                </TableRow>
                                            </TableBody>
                                        </Table>
                                    </TableContainer>
